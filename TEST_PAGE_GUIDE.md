...
Pre-set to: `https://payment-processing-function.azurewebsites.net/api/transaction`

To test against a local payment processor:

1. Edit the "API Endpoint" field
2. Paste local URL (e.g., `https://payment-processing-function.azurewebsites.net/api/transaction`)
...
```bash
func start
# Output: Http Functions: processTransaction [POST] https://payment-processing-function.azurewebsites.net/api/transaction
```

#### 3. Configure Test Page

Set **API Endpoint** to: `https://payment-processing-function.azurewebsites.net/api/transaction`
...
2. After submitting a form, check **Transactions\_\_c** object
