...
| `TRANSACTION_CATEGORIES` | Comma-separated list of allowed categories | `General Giving,General Donation,Building Fund,Missions,Youth Ministry,Benevolence,Special Events,Memorial,Uncategorized` | `Giving,Building,Missions` |
